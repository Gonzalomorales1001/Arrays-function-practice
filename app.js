...
const examinarString=(string)=>{
    if(!string){return 'Falló'}
    if(string===string.toUpperCase()){
        return 'LA FRASE ESTA TOTALMENTE EN MAYÚSCULAS'
    }
    if(string===string.toLowerCase()){
        return 'la frase esta totalmente en minúsculas'
    }
...
const calcularPerimetro=()=>2*(base+altura)

console.log("el perimetro es: ",calcularPerimetro())